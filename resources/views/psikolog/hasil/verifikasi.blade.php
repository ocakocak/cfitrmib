...
<form method="post" action="{{ route('hasil.keluarkanhpp', $hasil->id_hasil) }}"  enctype="multipart/form-data"style="width: 100%" enctype="multipart/form-data">
    @csrf
    @method('patch')
<div class="table-responsive">
    @if($hasil->kesimpulan != null)
    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="color: black">
    <tr align ="center">
        <th>KESIMPULAN</th>
    </tr>
...
<button type="submit" class="btn btn-primary btn-md mt-3 font-weight-bold">Verifikasi</button>
  {{-- <div class="col-md-12">
    <p align="right">
